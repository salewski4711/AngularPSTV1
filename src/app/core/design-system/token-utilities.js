...
let TokenUtils = class TokenUtils {
     ...
     */
    static getColorClass(property, token) {
     ...
     */
    static getSpacingClass(property, size) {
     ...
     */
    static getFontWeightClass(weight) {
        return `font-${weight}`;
    }
    /**
     ...
     */
    static getComponentClasses(component, options) {
        const classes = [];
     ...
     */
    static getComponentBaseClasses(component) {
        const baseClassMap = {
    ...
    static getComponentVariantClasses(component, variant) {
        const variantMap = {
            'button': {
    ...
    static getComponentSizeClasses(component, size) {
        const sizeMap = {
            'button': {
    ...
    static getComponentStateClasses(component, state) {
        const classes = [];
        if (state.disabled) {
     ...
     * @returns Token-Wert
     */
    static getComponentToken(component, path) {
     ...
     */
    static getTransitionClass(duration = 'base', property = 'all') {
        const durationMap = {
            fast: '150',
            base: '200',
            slow: '300',
     ...
     */
    static getAnimationClass(animation) {
        const animationMap = {
            'spin': 'animate-spin',
            'ping': 'animate-ping',
            'pulse': 'animate-pulse',
